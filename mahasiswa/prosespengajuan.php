...
for ($i=0; $i < count($tgl1_m1); $i++) { 
	$sql1 = "INSERT INTO `jadwal_shifting`(`id_pengajuan`, `minggu`, `tanggal_1`, `tanggal_2`, `jadwal`) VALUES ('".$id_pengajuan."',1,'".$tgl1_m1[$i]."','".$tgl2_m1[$i]."','".$jadwal_m1[$i]."')";
...
for ($i=0; $i < count($tgl1_m2); $i++) { 
	$sql1 = "INSERT INTO `jadwal_shifting`(`id_pengajuan`, `minggu`, `tanggal_1`, `tanggal_2`, `jadwal`) VALUES ('".$id_pengajuan."',2,'".$tgl1_m2[$i]."','".$tgl2_m2[$i]."','".$jadwal_m2[$i]."')";
	$execute = mysqli_query($conn,$sql1);
...
for ($i=0; $i < count($tgl1_m3); $i++) { 
	$sql1 = "INSERT INTO `jadwal_shifting`(`id_pengajuan`, `minggu`, `tanggal_1`, `tanggal_2`, `jadwal`) VALUES ('".$id_pengajuan."',3,'".$tgl1_m3[$i]."','".$tgl2_m3[$i]."','".$jadwal_m3[$i]."')";
	$execute = mysqli_query($conn,$sql1);
...
for ($i=0; $i < count($tgl1_m4); $i++) { 
	$sql1 = "INSERT INTO `jadwal_shifting`(`id_pengajuan`, `minggu`, `tanggal_1`, `tanggal_2`, `jadwal`) VALUES ('".$id_pengajuan."',4,'".$tgl1_m4[$i]."','".$tgl2_m4[$i]."','".$jadwal_m4[$i]."')";
	$execute = mysqli_query($conn,$sql1);
	if ($execute) {
