 ...
 <li class="">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="tambahdatabaru.php"><i class="fa fa-spinner"></i> Tambah Data Mahasiswa Baru</a></li>
          </ul>
        </li>
      </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       ...
       <h2 align="center"><b>Tambah Mahasiswa Baru</b>
        <small></small>
      </h2>
      <form action="tambah_mhs_config.php" method="post">
      <b>Nim</b>
      <input type="" class="form-control" name="nim" value= "" required="">

      <b>Nama</b>
      <input type="" class="form-control" name="nama" value= "" required="">
      ...
      <b>Tahun Masuk</b>
      <input type="" class="form-control" name="tahun_masuk" value= "" required="">

      <b>Alamat</b>
      <input type="" class="form-control" name="alamat" value= "" required="">

      <b>No.Telp</b>
      <input type="" class="form-control" name="no_telp" value= "" required="">

      <b>User name</b>
      <input type="" class="form-control" name="username" value= "" required="">
